...
variable "cluster_name" {
  ...
  default     = "aks-wesco-standard-prod"
}

variable "resource_group" {
  description = "Resoruce Group Name"
  default     = "rg-wesco-standard-prod"
}
...
variable "subnet_name" {
  ...
  default     = "snet-aks-wesco-standard-prod"
}


variable "vnet_name" {
  description = "name of the vnet that this subnet will belong to"
  default     = "vnet-aks-wesco-standard-prod"
}
...
variable "network_security_group_name" {
  ...
  default     = "nsg-aks-wesco-standard-prod"
}
...
variable "pendpoint_subnetname" {
  default = "pe-aks-wesco-standard-prod"
}

variable "acr_name" {
  default     = "acrstandardprod"
...
variable "appgw_subnetname" {
  ...
  default     = "appgw-aks-wesco-standard-prod"
}
